...
public class CrudBean implements Serializable{
	...
	public void saveBtnOnclick() {
		try {
			...
			if (this.employeeEdit.getAgeVali(this.employeeEdit.getBirthDate()) < 2) {
			...
			mode = "U";
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "บันทึกข้อมูลเรียบร้อย"));
	...
	public void updateBtnOnclick() {
		try {
			...
			if (this.employeeEdit.getAgeVali(this.employeeEdit.getBirthDate()) < 2) {
				FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", "อายุต้องมากกว่า 2 ปี"));
	...
	public void deleteBtnOnclick() {
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "ลบสำเร็จ"));
